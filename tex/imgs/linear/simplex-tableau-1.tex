...
\begin{tikzpicture}[
 ...
 \explain
    {right=0cm, above=-4.5cm} {in=90, out=180}
    {risk_cell1}{risk_box}
    {
 ...
 \explain
    {right=-.3cm, above=4.2cm} {in=-145, out=180}
    {a11_cell}{a11_box}
    {
        Для збільшення $x_1$ на 1 потрібно зменшити $s_1$ на $a_{11}=2$. Так само для решти чисел таблиці.
    }
    {pink};

 \explain
    {right=-.55cm, above=5.1cm, text width=8cm} {in=-30, out=70}
 ...
 \explain
    {right=3cm, above=-3.2cm, text width= 3.8cm} {in=170, out=-30}
 ...
 \explain
    {right=2.8cm, above=-1.7cm, text width=3.2cm} {in=200, out=0}
 ...
 \explain
    {right=-1.15cm, above=3.4cm, text width=2.6cm} {in=-145, out=180}
    {a22_cell}{a22_box}
    {
        Аналогічно, \\
